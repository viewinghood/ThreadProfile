...
#3start
        ...
        def bsw(major_diameter_in: Fraction, tpi: float):
            name = f'{format_rational(major_diameter_in)} in BSW'
            major_diameter = major_diameter_in * 25.4
            return preset_v_thread(name, major_diameter, ttp(tpi),  55)
        ...
        if len (presets) == 0:
            ...
            ['Garden Hose NHR',0.08696*25.4,0.9495*25.4,0.9720*25.4],
                ...
                uns(Fraction(6), 10),
                uns(Fraction(6), 14),
                bsw(Fraction(1, 16), 60),
                bsw(Fraction(3, 32), 48),
                bsw(Fraction(1, 8), 40),
                bsw(Fraction(5, 32), 32),
                bsw(Fraction(3, 16), 24),
                bsw(Fraction(7, 32), 24),
                bsw(Fraction(1, 4), 20),
                bsw(Fraction(5, 16), 18),
                bsw(Fraction(3, 8), 16),
                bsw(Fraction(7, 16), 14),
                bsw(Fraction(1, 2), 12),
                bsw(Fraction(9, 16), 12),
                bsw(Fraction(5, 8), 11),
                bsw(Fraction(3, 4), 10),
                bsw(Fraction(7, 8), 9),
                bsw(Fraction(1), 8),
                ...
                bsw(mixed(3, 3, 4), 3),
                bsw(Fraction(4), 3),
                bsw(mixed(4, 1, 4), 2 + 7 / 8),
                bsw(mixed(4, 1, 2), 2 + 7 / 8),
                bsw(mixed(4, 3, 4), 2 + 3 / 4),
                bsw(Fraction(5), 2 + 3 / 4),
                bsw(mixed(5, 1, 4), 2 + 5 / 8),
                bsw(mixed(5, 1, 2), 2 + 5 / 8),
                bsw(mixed(5, 3, 4), 2.5),
                bsw(Fraction(6), 2.5)
            ]
        else:
